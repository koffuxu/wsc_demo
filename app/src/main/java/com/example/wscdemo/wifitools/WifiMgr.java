...
//				resList = sortByLevel(tmpList);
	...
	public boolean connectWifi(final String pwd, ScanResult scanResults) throws InterruptedException {
        if(scanResults == null ) {
            return false;
        }
    ...
    public void connectWifi( String ssid, String pwd, int type) {
        ...
        WifiConfiguration configuration = createWifiInfo(ssid, pwd, type);
